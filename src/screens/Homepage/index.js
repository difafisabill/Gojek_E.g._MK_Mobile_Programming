    ...
    <View style={wallet.container}>
      <View
        ...
        <View style={wallet.debit}>
          <Text style={wallet.saldo}>Rp 702.000</Text>
          <Text style={wallet.coin}>45 Coins</Text>
        </View>
      </View>
      <View
        style={{
...
const Rating = () => {
  return (
    <View style={rating.container}>
      <Text style={rating.title}>Restoran Menarik Untukmu !</Text>
      <View style={rating.horizontalCard}>
        ...
        <View style={{alignItems: 'center'}}>
          <View style={rating.content}>
            <Image source={driver} style={rating.driver} />
            <View style={rating.description}>
              <Text
                ...
                Ketupat Sayur Komplit
              </Text>
              <Text style={rating.text}>Sidoagung Singosari - Malang</Text>
              <Text style={rating.text}>Rp 20.000,-</Text>
            </View>
          </View>
